...
namespace Sicsoft.Checkin.Web
{
   ...
   .AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<MonedasViewModel, bool>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/VCierre"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
...
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<BitacoraCierresViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/BitacoraCierres"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
