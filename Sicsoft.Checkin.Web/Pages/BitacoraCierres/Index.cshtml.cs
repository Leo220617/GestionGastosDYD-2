...
namespace GestionGastos20.Pages.BitacoraCierres
{
    public class IndexModel : PageModel
    {
        private readonly IConfiguration configuration;
        private readonly ICrudApi<BitacoraCierresViewModel, int> service;
        ...
        [BindProperty]
        public BitacoraCierresViewModel[] Objeto { get; set; }

        [BindProperty]
        public UsuariosViewModel[] Usuarios { get; set; }

        public IndexModel(ICrudApi<BitacoraCierresViewModel, int> service, ICrudApi<UsuariosViewModel, int> users)
        {
