...
{
    public class EditarPModel : PageModel
    {
        ...
        public EditarPModel(ICrudApi<ComprasViewModel, int> service, ICrudApi<LoginUsuarioViewModel, int> usuario, ICrudApi<GastosViewModel, int> gastos,
