...
{
    public class EditarGModel : PageModel
    {
        ...
        private readonly ICrudApi<ComprasViewModel, int> compras2;
        ...
        public EditarGModel(ICrudApi<ComprasViewModel, int> service, ICrudApi<LoginUsuarioViewModel, int> usuario, ICrudApi<GastosViewModel, int> gastos,
          ICrudApi<GastosR, int> liquidaciones, ICrudApi<ComprasViewModel, int> compras, ICrudApi<ComprasInsercionViewModel, int> insercionCompras, ICrudApi<ProveedoresViewModel, int> proveedor, ICrudApi<ComprasViewModel, int> compras2)
        {
            this.gastos = gastos;
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            try
            {
                ...
                var ComprasX = await compras2.ObtenerLista(filtro);
                int idInt = Convert.ToInt32(id);
                Compras = ComprasX.Where(a => a.idCierre == idInt).ToArray();
