...
{
    public class EditarHModel : PageModel
    {
        ...
        public EditarHModel(ICrudApi<ComprasViewModel, int> service, ICrudApi<LoginUsuarioViewModel, int> usuario, ICrudApi<GastosViewModel, int> gastos,
