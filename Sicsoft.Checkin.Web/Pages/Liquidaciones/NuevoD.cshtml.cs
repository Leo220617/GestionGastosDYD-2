...
{
    public class NuevoDModel : PageModel
    {
        ...
        public NuevoDModel(ICrudApi<ComprasViewModel, int> service, ICrudApi<LoginUsuarioViewModel, int> usuario, ICrudApi<GastosViewModel, int> gastos,
