...
{
    public class NuevoHModel : PageModel
    {
        ...
        public NuevoHModel(ICrudApi<ComprasViewModel, int> service, ICrudApi<LoginUsuarioViewModel, int> usuario, ICrudApi<GastosViewModel, int> gastos,
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                if (Pais == "D")
                {
                    ...
                    moneda.identificador = "RD$";
                    moneda.Moneda = "Peso Dominicano";
                ...
                if (Pais == "H")
                {
                    ...
                    moneda3.identificador = "HNL";
                    moneda3.Moneda = "Lempira hondureño";
