...
{
    public class NuevoPModel : PageModel
    {
        ...
        public NuevoPModel(ICrudApi<ComprasViewModel, int> service, ICrudApi<LoginUsuarioViewModel, int> usuario, ICrudApi<GastosViewModel, int> gastos,
